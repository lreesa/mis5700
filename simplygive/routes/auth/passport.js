...
async function savePerson({ name, birthday, gender, relationship, entertainment, personalCare, sport, craft, userEmail }) {
  console.log(name)
  ...
  const people = await sqlFetch`
		INSERT INTO people
			( -- columns to insert data into
			[name], [birthday], [gender], [relationship], [entertainment], [personalCare], [sport], [craft], [userEmail]
			)
		VALUES
			( -- first row: values for the columns in the list above
					${name}, ${birthday}, ${gender}, ${relationship}, ${entertainment}, ${personalCare}, ${sport}, ${craft}, ${userEmail}
    ...
    SELECT * 
    FROM people`; // 		( -- SELECT id FROM people WHERE userEmail = ${userEmail})
  console.log(people)
  return people;
}
    ...
    new LocalStrategy(
      {
        ...
        entertainmentField: "entertainment",
        personalCareField: "personalCare", 
        sportField: "sport", 
        craftField: "craft",
        passReqToCallback: true // allows us to pass back the entire request to the callback
      },
      async function(req, name, birthday, gender, relationship, 
        entertainment, personalCare, sport, craft, userEmail, done) {
        console.log('started saving...')
        var userEmail = req.user.email
        var people = await savePerson({name, birthday, gender, relationship, 
          entertainment, personalCare, sport, craft, userEmail})
        console.log('finished saving people')
